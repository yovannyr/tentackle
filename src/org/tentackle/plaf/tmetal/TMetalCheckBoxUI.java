...
// $Id: TMetalCheckBoxUI.java 337 2008-05-09 18:35:27Z harald $
 ...
 * @author harald
 */
public class TMetalCheckBoxUI extends MetalCheckBoxUI {
    
  private static final TMetalCheckBoxUI tMetalCheckBoxUI = new TMetalCheckBoxUI();
  ...
  public static ComponentUI createUI(JComponent c) {
      return tMetalCheckBoxUI;
  }
    

  /**
   * overridden to paint flashing focus and to paint the focus
  ...
  public synchronized void paint(Graphics g, JComponent c) {
      ...
      if (b instanceof FormCheckBox) {
        selectedColor = ((FormCheckBox)b).getSelectedColor();
        unselectedColor = ((FormCheckBox)b).getUnselectedColor();
      }
