...
// $Id: TLooksCheckBoxUI.java 337 2008-05-09 18:35:27Z harald $
 ...
 * @author harald
 */
public class TLooksCheckBoxUI extends MetalCheckBoxUI {
  
  private static final TLooksCheckBoxUI tLooksCheckBoxUI = new TLooksCheckBoxUI();
  ...
  public synchronized void paint(Graphics g, JComponent c) {
      ...
      viewRect.x += i.left + 1;
      viewRect.y += i.top;
      viewRect.width -= (i.right + viewRect.x) - 1;
