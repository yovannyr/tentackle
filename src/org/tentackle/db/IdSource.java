...
// $Id: IdSource.java 336 2008-05-09 14:40:20Z harald $
...
public interface IdSource {
   ...
   *
   * @return a free ID.
   * @throws ApplicationException if an ID could not be retrieved.
   *
   */
   ...
   * @throws ApplicationException if ID could not be returned
   */
