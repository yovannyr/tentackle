...
// $Id: FormFieldVerticalAlignmentEditor.java 336 2008-05-09 14:40:20Z harald $
 ...
 * @author harald
 */
public class FormFieldVerticalAlignmentEditor extends PropertyEditorSupport {
  ...
  public FormFieldVerticalAlignmentEditor() {
  }
  ...
  public String getAsText() {
    ...
    else if (alignment == JLabel.BOTTOM) {
      return options[2];
    }
    else {
      return options[0];
  ...
  public void setAsText(String s) {
    if      (options[1].equals(s)) {
      ...
      setValue(new Integer(JLabel.BOTTOM));
    }
    else {
      setValue(new Integer(JLabel.TOP));
    }
  }
