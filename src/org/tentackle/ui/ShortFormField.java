...
// $Id: ShortFormField.java 336 2008-05-09 14:40:20Z harald $
 ...
 * @author harald
 */
public class ShortFormField extends NumberFormField {


  /**
   * Creates an empty ShortFormField.<br>
  ...
  /**
   * @return the short value, null if empty
   */
  @Override
  public Short getFormValue ()  {
    ...
    if (str != null) {
      ...
      if (str.length() > 0) {
        try {
          return new Short(format.parse(str).shortValue());
        } 
   ...
   * 
   * @return the short value, 0.0 if empty.
   */
  public short getShortValue() {
    Short value = getFormValue();
