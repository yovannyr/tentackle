...
// $Id: AppRemoteDbSession.java 439 2008-09-18 15:09:32Z harald $
...
public interface AppRemoteDbSession extends RemoteDbSession {
  ...
  /**
   * Gets the object id associated with the {@link AppUserInfo} passed in to AppRemoteDbConnection#login.
   * @return the user id
