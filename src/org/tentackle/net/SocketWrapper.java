 ...
 * to add compression over SSLSockets (which are abstract and created by a factory).
 * It works by replacing the SocketImpl by a wrapped SocketImpl.
 */
public abstract class SocketWrapper extends Socket {

  private Socket socket;    // the wrapped socket (there is no public getImpl() in Socket :-()
   ...
   * @throws SocketException if creating the socket failed.
   */
  ...
  public boolean equals(Object obj) {
    // this is important! otherwise we get internal_error alerts in SSL-layer!
